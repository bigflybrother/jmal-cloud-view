              ...
              <div class="token-item">
                ...
                <div class="item-content">
                  ...
                  <div class="item-desc">
                    ...
                    <i>
                      <svg-icon
                        v-if="token.lastActiveTime"
                        icon-class="zuijinhuoyue"
                      ></svg-icon
                      ><i v-if="!token.lastActiveTime" class="el-icon-info"></i
                      >{{
                        token.lastActiveTime
                          ? "最近活动于 " + token.lastActiveTime
                          : "没有最近活动"
                      }}
                    </i>
                  </div>
    ...
    onSave() {
      this.$refs.managerForm.validate(valid => {
        ...
        if (valid) {
          ...
          settingApi
            .generateAccessToken({ tokenName: this.form.name })
            .then(res => {
